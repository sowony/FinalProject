...
--지도
DROP SEQUENCE WMAPSEQ;
DROP TABLE WMAP;

CREATE SEQUENCE WMAPSEQ;
CREATE TABLE WMAP(
	WMAPNO NUMBER PRIMARY KEY,
--	WNO NUMBER,
...
--	CONSTRAINT FK_WMAP FOREIGN KEY(WNO)
...
CREATE SEQUENCE WESEQ;
CREATE TABLE WEDITOR(
	WENO NUMBER PRIMARY KEY,
--	WNO NUMBER,
	WECONTENT CLOB
	CONSTRAINT PK_WEDITOR PRIMARY KEY(WENO)
--	CONSTRAINT FK_WEDITOR FOREIGN KEY(WNO)
--	REFERENCES WIDGET(WNO)
);